...
function EditNews() {
  ...
  return (
    ...
    <div className=" w-full  h-fit bg-white rounded-lg shadow-lg mt-5">
      <header className="h-11 justify-items-center">
        <h1 className="text-center text-xl font-semibold p-1">Edit News</h1>
          ...
          <Row gutter={16}>
            <Col lg={24}>
              ...
              >
                ...
                <Button htmlType="submit" className="bg-[#4ad991]">Edit News</Button>
              </Form.Item>
            </Col>
          </Row>
        </Form>
